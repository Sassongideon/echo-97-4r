    ...
    <footer className="bg-navy-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-blue-200 leading-relaxed">
              Where creativity meets culture, and every voice has the power to inspire, entertain, and connect with
              thousands across Singapore.
            </p>
          </div>
        ...
        <div className="border-t border-blue-800 mt-8 pt-8 text-center text-blue-300">
          ...
          <p className="text-sm mt-2">Created by Sasson Gideon Saminathan - Ngee Ann Polytechnic, Class: TB07</p>
        </div>
      </div>
    </footer>
  )
